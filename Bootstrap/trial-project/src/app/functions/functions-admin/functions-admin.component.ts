...
goHome() {
  ...
  displayedColumns: string[] = [ 'bookName', 'bookAuthor', 'noOfBook', 'price','bookImage','description', 'actions'];
  displayedColumn: string[] = [ 'book Name', 'book Author', 'no. Of Book', 'price','book Image','description', 'actions'];
